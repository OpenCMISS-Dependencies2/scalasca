...
/**
 * Returns the current position of the buffer instance in bytes.
 *
 * @return Reading position
 */
size_t
Buffer::position() const
{
    return m_position;
}
 ...
 **/
void
Buffer::put_id(const ident_t& id)
{
    put_value(id);
}
 ...
 **/
void
Buffer::putTimestamp(const timestamp_t& timestamp)
{
    put_value(timestamp);
}
 ...
 **/
void
Buffer::put_uint8(const uint8_t& value)
{
    put_value(value);
}
 ...
 **/
void
Buffer::put_uint32(const uint32_t& value)
{
    put_value(value);
}
...
/**
 *  Appends the given signed 64-bit integer @a value to the buffer. If not
 *  enough buffer space is available, the buffer will be automatically resized.
 *
 *  @param value Value to be appended
 **/
void
Buffer::put_int64(const int64_t& value)
{
    put_value(value);
}
 ...
 **/
void
Buffer::put_uint64(const uint64_t& value)
{
    put_value(value);
}
 ...
 **/
void
Buffer::put_double(const double& value)
{
    put_value(value);
}
 ...
 **/
void
Buffer::put_event(const Event& event)
{
    event.pack(*this);
}
 ...
 **/
void
Buffer::put_buffer(const Buffer& buffer)
{
...
/**
 *  Returns the 64-bit signed integer value stored in the buffer at the
 *  current read position.
 *
 ...
 **/
RemoteEvent
Buffer::get_event(const GlobalDefs& defs)
{
...
template< typename T >
void
Buffer::put_value(const T& value)
{
 ...
 **/
void
Buffer::reserve(std::size_t nbytes)
{
