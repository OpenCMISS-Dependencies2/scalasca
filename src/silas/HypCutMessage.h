...
#ifndef SILAS_HYPCUTMESSAGE_H
#define SILAS_HYPCUTMESSAGE_H
    ...
    : public HypothesisPart
{
    ...
    public:
        ...
        void
        register_message_size(const std::string& rel,
                              int                rval);

        void
        register_message_tag(const std::string& rel,
                             int                rval);
    ...
    private:
         ...
         */
        void
        remove_message(const pearl::Event&  exit,
                       silas::CallbackData* data);

        void
        check_call_removal(const pearl::Event&  exit,
                           silas::CallbackData* data);

        void
        cb_noop(const pearl::CallbackManager& cbmanager,
                int                           user_event,
                const pearl::Event&           event,
                pearl::CallbackData*          cdata);

        void
        cb_check_send(const pearl::CallbackManager& cbmanager,
                      int                           user_event,
                      const pearl::Event&           event,
                      pearl::CallbackData*          cdata);
         ...
         */
        void
        cb_check_recv(const pearl::CallbackManager& cbmanager,
                      int                           user_event,
                      const pearl::Event&           event,
                      pearl::CallbackData*          cdata);
        ...
        bool
        is_registered(const pearl::Event& event);
