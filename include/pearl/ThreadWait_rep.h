 ...
 *  @file
 *  @ingroup PEARL_base
 *  @brief   Declaration of the class ThreadWait_rep.
 *
 *  This header file provides the declaration of the class ThreadWait_rep.
 **/
/*-------------------------------------------------------------------------*/


#ifndef PEARL_THREADWAIT_REP_H
#define PEARL_THREADWAIT_REP_H
 ...
 *  @ingroup PEARL_base
 *  @brief   %Event representation for THREAD_WAIT events.
 **/
/*-------------------------------------------------------------------------*/

class PEARL_NOPAD_ATTR ThreadWait_rep
    : public pearl::Event_rep
{
    public:
        ...
        ThreadWait_rep(timestamp_t   timestamp,
                       Communicator* threadContingent,
                       uint64_t      sequenceCount);

        ThreadWait_rep(const GlobalDefs& defs,
                       Buffer&           buffer);
