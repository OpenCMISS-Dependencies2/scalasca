                                  ...
                                  const OTF2_IdMap* idMap )
{
    ...
    record_data_length += otf2_buffer_size_uint8( mappingType );
    if ( !idMap )
    {
        return UTILS_ERROR( OTF2_ERROR_INVALID_ARGUMENT,
                            "Invalid IdMap argument." );
    }
    record_data_length += otf2_buffer_size_id_map( idMap );
                                 ...
                                 double          standardDeviation )
{
    ...
    record_data_length += otf2_buffer_size_timestamp( time );
    record_data_length += otf2_buffer_size_int64( offset );
    record_data_length += otf2_buffer_size_float64( standardDeviation );
    /* Finalize the upper bound of the record. */
    record_length += record_data_length;
                                           ...
                                           OTF2_AttributeValue   value )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_LOCATION_GROUP_PROPERTY );
                                      ...
                                      OTF2_AttributeValue value )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_LOCATION_PROPERTY );
                                   ...
                                   OTF2_CartPeriodicity  cartPeriodicity )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_CART_DIMENSION );
                                  ...
                                  const OTF2_CartDimensionRef* cartDimensions )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_CART_TOPOLOGY );
                                    ...
                                    const uint32_t*      coordinates )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_CART_COORDINATE );
                                        ...
                                        uint32_t                   lineNumber )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_SOURCE_CODE_LOCATION );
                                    ...
                                    OTF2_CallingContextRef     parent )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_CALLING_CONTEXT );
                                            ...
                                            OTF2_AttributeValue    value )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_CALLING_CONTEXT_PROPERTY );
                                        ...
                                        uint64_t                    period )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_INTERRUPT_GENERATOR );
...
OTF2_ErrorCode
OTF2_DefWriter_WriteIoFileProperty( OTF2_DefWriter*     writerHandle,
                                    ...
                                    OTF2_AttributeValue value )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_IO_FILE_PROPERTY );
...
OTF2_ErrorCode
OTF2_DefWriter_WriteIoRegularFile( OTF2_DefWriter*        writerHandle,
                                   OTF2_IoFileRef         self,
                                   OTF2_StringRef         name,
                                   OTF2_SystemTreeNodeRef scope )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_IO_REGULAR_FILE );
...
OTF2_ErrorCode
OTF2_DefWriter_WriteIoDirectory( OTF2_DefWriter*        writerHandle,
                                 OTF2_IoFileRef         self,
                                 OTF2_StringRef         name,
                                 OTF2_SystemTreeNodeRef scope )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_IO_DIRECTORY );
...
OTF2_ErrorCode
OTF2_DefWriter_WriteIoHandle( OTF2_DefWriter*    writerHandle,
                              ...
                              OTF2_IoHandleRef   parent )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_IO_HANDLE );
...
OTF2_ErrorCode
OTF2_DefWriter_WriteIoPreCreatedHandleState( OTF2_DefWriter*   writerHandle,
                                             ...
                                             OTF2_IoStatusFlag statusFlags )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_IO_PRE_CREATED_HANDLE_STATE );
...
OTF2_ErrorCode
OTF2_DefWriter_WriteCallpathParameter( OTF2_DefWriter*     writerHandle,
                                       ...
                                       OTF2_AttributeValue value )
{
    ...
    OTF2_Buffer_WriteUint8( writerHandle->buffer, OTF2_LOCAL_DEF_CALLPATH_PARAMETER );
